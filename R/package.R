...
#' nvForest model states do not encode their deployment device. Native
#' operations fail with an installation instruction until their corresponding
#' backend is installed. Set
