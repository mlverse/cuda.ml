...
listed below (which is a subset of
[algorithms supported by RAPIDS cuML](
  https://github.com/NVIDIA/cuml#supported-algorithms
)).
...
Windows, install and run R inside a
...
See [Install and manage cuda.ml](
  https://mlverse.github.io/cuda.ml/articles/install-manage.html
