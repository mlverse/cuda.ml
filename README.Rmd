...
Native operations require Linux x86_64 with glibc 2.28 or newer. GPU operations
also require a supported NVIDIA GPU and driver 580 or newer; the CPU-only
nvForest backend requires neither.
